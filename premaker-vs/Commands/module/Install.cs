...
namespace Premaker.Commands.module
{
    /// <summary>
    /// Command handler
    /// </summary>
    internal sealed class Install
    {
        ...
        /// Command ID.
        /// </summary>
        public const int CommandId = 16643;
        ...
        private Install(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in Install's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new Install(package, commandService);
        }
...
#pragma warning restore VSTHRD100 // Avoid async void methods
        {
            ...
            {
                await Terminal.RunAsync($"module install {dialog.InputText}", true);
            }
        }
    }
}
